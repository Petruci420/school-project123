    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                persona: {
                    red: "hsl(var(--persona-red))",
                    crimson: "hsl(var(--persona-crimson))",
                    gold: "hsl(var(--persona-gold))",
                    electric: "hsl(var(--persona-electric))",
                    neon: "hsl(var(--persona-neon))",
                    dark: "hsl(var(--persona-dark))",
                    darker: "hsl(var(--persona-darker))",
                },
                sidebar: {
